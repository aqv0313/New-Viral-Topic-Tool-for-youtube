...
keywords = [
"5 Best Skincare Products for Beginners", "10 Minute Morning Workout to Burn Fat Fast", "Night Skincare Routine for Glowing Skin",
    ...
    try:
        ...
        for keyword in keywords:
            ...
            for video, stat, channel in zip(videos, stats, channels):
                ...
                if subs < 53000:  # Only include channels with fewer than 3,000 subscribers
                    all_results.append({
                        "Title": title,
